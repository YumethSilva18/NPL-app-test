...
export function HistoryPage() {
  ...
  useEffect(() => {
    const loadHistory = async () => {
      ...
      try {
        ...
        console.log('API history not available, using demo data');
  ...
  const filteredHistory = useMemo(() => {
    return history.filter((item) => {
      ...
      if (
        debouncedSearch &&
        !item.customerId.toLowerCase().includes(debouncedSearch.toLowerCase())
      ) {
        return false;
      }
      // Risk level filter
  ...
  }, [debouncedSearch, filters.riskLevel, filters.decisionHint, filters.dateFrom, filters.dateTo, history]);
  ...
  filters.dateTo;
  return (
    <Layout onRefresh={handleRefresh} onExport={handleExport}>
